...
export const MODELOS = [
  { id: "cosmopolitan", nombre: "Cosmopolitan", prefix: "MC", img: "/modelos/cosmopolitan.jpg" },
  { id: "espressomartini", nombre: "Espresso Martini", prefix: "ME", img: "/modelos/espressomartini.jpg" },
  { id: "cubalibre", nombre: "Cuba Libre", prefix: "MCL", img: "/modelos/cubalibre.jpg" },
  { id: "negroni", nombre: "Negroni", prefix: "MN", img: "/modelos/negroni.jpg" },
  { id: "moscowmule", nombre: "Moscow Mule", prefix: "MM", img: "/modelos/moscowmule.jpg" },
];

export const TALLAS = ["XS", "S", "M", "L", "XL"];
export const PLATAFORMAS = ["Instagram", "WhatsApp", "Evento", "Cash", "Otro"];
export const PAGOS = [
  "Zelle", "Venmo", "Cash", "Pago Móvil", "Transferencia", "Zinli", "USDT",
...
// Listas reducidas usadas solo en los FILTROS de búsqueda (Ventas y Clientes).
// El formulario de registrar venta sigue usando las listas completas de arriba.
export const PLATAFORMAS_FILTRO = PLATAFORMAS.filter((p) => p !== "Cash");
export const REFERIDOS_FILTRO = ["Juan Cristóbal"];
